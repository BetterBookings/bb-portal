    ...
    <div style={sheet} onClick={e=>e.stopPropagation()}>
      ...
      {step==="select"&&<>
        <div style={body}>
          ...
          {!loading&&(!opts||!opts.flight||!legs.length)&&<div style={{color:"#5b6470",fontSize:14}}>{bf.noflight}</div>}
