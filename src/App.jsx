...
const API_TRANSFER = "https://review.better-bookings.com/api/ext/transfer";
...
const FUEL = {
  fullfull:{EN:"Full to full (return full)",IT:"Pieno/pieno (riconsegna col pieno)",ES:"Lleno/lleno (devolución con depósito lleno)",FR:"Plein/plein (restitution avec le plein)",NL:"Vol/vol (vol terugbrengen)",DE:"Voll/voll (voll zurückgeben)"},
  emptyempty:{EN:"Empty to empty",IT:"Vuoto/vuoto",ES:"Vacío/vacío",FR:"Vide/vide",NL:"Leeg/leeg",DE:"Leer/leer"},
  fullempty:{EN:"Full, return empty",IT:"Pieno, riconsegna vuoto",ES:"Lleno, devolución vacío",FR:"Plein, restitution à vide",NL:"Vol, leeg terugbrengen",DE:"Voll, leer zurückgeben"},
  fullemptyrefund:{EN:"Full, unused fuel refunded",IT:"Pieno, carburante non usato rimborsato",ES:"Lleno, combustible no usado reembolsado",FR:"Plein, carburant non utilisé remboursé",NL:"Vol, ongebruikte brandstof terugbetaald",DE:"Voll, nicht genutzter Kraftstoff erstattet"},
  fullemptyfree:{EN:"Full, return empty (free)",IT:"Pieno, riconsegna vuoto (gratis)",ES:"Lleno, devolución vacío (gratis)",FR:"Plein, restitution à vide (gratuit)",NL:"Vol, leeg terugbrengen (gratis)",DE:"Voll, leer zurückgeben (gratis)"},
  halfhalf:{EN:"Half to half",IT:"Metà/metà",ES:"Mitad/mitad",FR:"Moitié/moitié",NL:"Half/half",DE:"Halb/halb"},
  samelevel:{EN:"Same level",IT:"Stesso livello",ES:"Mismo nivel",FR:"Même niveau",NL:"Zelfde niveau",DE:"Gleicher Stand"},
  unknown:{EN:"Not specified",IT:"Non specificato",ES:"No especificado",FR:"Non spécifié",NL:"Niet gespecificeerd",DE:"Nicht angegeben"},
};
...
const CF = {
  EN:{open:"Search & book a car",title:"Car rental",pickup:"Pick-up location",dropoff:"Drop-off location",same:"Drop-off same as pick-up",from:"Pick-up date & time",to:"Drop-off date & time",age:"Driver age",res:"Country of residence (ISO)",search:"Search cars",searching:"Searching…",results:"Available cars",none:"No cars available for these dates / location.",total:"Total",deposit:"Security deposit",fuel:"Fuel policy",mileage:"Mileage",unlimited:"Unlimited km",limited:"km included",extraKm:"Extra km",excess:"Insurance excess (CDW / theft)",cancel:"Cancellation policy",included:"What's included",extras:"Optional extras",onreq:"On request — confirmed by supplier",driver:"Driver details",fn:"First name",ln:"Last name",email:"Email",phone:"Phone",bdate:"Date of birth",bcountry:"Country of birth (ISO)",rcity:"City of residence",rcountry:"Country of residence (ISO)",raddr:"Address",cont:"Continue",back:"Back",toDriver:"Continue to driver details",toPay:"Continue to payment",payTitle:"Payment",payNote:"💳 Online card payment is being activated. Your car and details are saved — once enabled you'll pay securely here and the booking is confirmed instantly.",payBtn:"Pay & confirm booking",doneTitle:"Booking confirmed!",doneMsg:"You'll receive the confirmation details by email.",ref:"Booking reference",voucher:"View voucher",close:"Done",payErr:"Payment could not be completed. Please try again.",bookErr:"Payment taken but the booking is still pending — our team will confirm it shortly.",driverSel:"Main driver",choose:"— choose —",yrs:"yrs",freeCancel:"Free cancellation until",cancelFee:"Cancellation fee from",nonref:"Non-refundable",reqFields:"Please select the driver and fill email, phone and date of birth."},
  IT:{open:"Cerca e prenota un'auto",title:"Noleggio auto",pickup:"Luogo di ritiro",dropoff:"Luogo di riconsegna",same:"Riconsegna nello stesso luogo",from:"Data e ora ritiro",to:"Data e ora riconsegna",age:"Età conducente",res:"Paese di residenza (ISO)",search:"Cerca auto",searching:"Ricerca…",results:"Auto disponibili",none:"Nessuna auto disponibile per queste date / luogo.",total:"Totale",deposit:"Cauzione",fuel:"Politica carburante",mileage:"Chilometraggio",unlimited:"Km illimitati",limited:"km inclusi",extraKm:"Km extra",excess:"Franchigia (danni / furto)",cancel:"Politica di cancellazione",included:"Cosa è incluso",extras:"Extra opzionali",onreq:"Su richiesta — confermata dal fornitore",driver:"Dati conducente",fn:"Nome",ln:"Cognome",email:"Email",phone:"Telefono",bdate:"Data di nascita",bcountry:"Paese di nascita (ISO)",rcity:"Città di residenza",rcountry:"Paese di residenza (ISO)",raddr:"Indirizzo",cont:"Continua",back:"Indietro",toDriver:"Continua ai dati conducente",toPay:"Continua al pagamento",payTitle:"Pagamento",payNote:"💳 Il pagamento online con carta è in fase di attivazione. L'auto e i tuoi dati sono salvati — una volta attivo pagherai in sicurezza qui e la prenotazione sarà confermata subito.",payBtn:"Paga e conferma prenotazione",doneTitle:"Prenotazione confermata!",doneMsg:"Riceverai i dettagli della conferma via email.",ref:"Riferimento prenotazione",voucher:"Vedi voucher",close:"Fatto",payErr:"Pagamento non riuscito. Riprova.",bookErr:"Pagamento effettuato ma la prenotazione è in attesa — il nostro team la confermerà a breve.",driverSel:"Conducente principale",choose:"— scegli —",yrs:"anni",freeCancel:"Cancellazione gratuita fino al",cancelFee:"Penale di cancellazione da",nonref:"Non rimborsabile",reqFields:"Seleziona il conducente e inserisci email, telefono e data di nascita."},
  ES:{open:"Buscar y reservar un coche",title:"Alquiler de coche",pickup:"Lugar de recogida",dropoff:"Lugar de devolución",same:"Devolución en el mismo lugar",from:"Fecha y hora de recogida",to:"Fecha y hora de devolución",age:"Edad del conductor",res:"País de residencia (ISO)",search:"Buscar coches",searching:"Buscando…",results:"Coches disponibles",none:"No hay coches disponibles para estas fechas / lugar.",total:"Total",deposit:"Fianza",fuel:"Política de combustible",mileage:"Kilometraje",unlimited:"Km ilimitados",limited:"km incluidos",extraKm:"Km extra",excess:"Franquicia (daños / robo)",cancel:"Política de cancelación",included:"Qué está incluido",extras:"Extras opcionales",onreq:"Bajo petición — confirmado por el proveedor",driver:"Datos del conductor",fn:"Nombre",ln:"Apellido",email:"Email",phone:"Teléfono",bdate:"Fecha de nacimiento",bcountry:"País de nacimiento (ISO)",rcity:"Ciudad de residencia",rcountry:"País de residencia (ISO)",raddr:"Dirección",cont:"Continuar",back:"Atrás",toDriver:"Continuar a datos del conductor",toPay:"Continuar al pago",payTitle:"Pago",payNote:"💳 El pago online con tarjeta se está activando. Tu coche y tus datos están guardados — una vez activo pagarás de forma segura aquí y la reserva se confirmará al instante.",payBtn:"Pagar y confirmar reserva",doneTitle:"¡Reserva confirmada!",doneMsg:"Recibirás los detalles de la confirmación por email.",ref:"Referencia de reserva",voucher:"Ver voucher",close:"Hecho",payErr:"No se pudo completar el pago. Inténtalo de nuevo.",bookErr:"Pago realizado pero la reserva sigue pendiente — nuestro equipo la confirmará en breve.",driverSel:"Conductor principal",choose:"— elegir —",yrs:"años",freeCancel:"Cancelación gratuita hasta",cancelFee:"Penalización de cancelación desde",nonref:"No reembolsable",reqFields:"Selecciona el conductor e introduce email, teléfono y fecha de nacimiento."},
  FR:{open:"Rechercher et réserver une voiture",title:"Location de voiture",pickup:"Lieu de prise en charge",dropoff:"Lieu de restitution",same:"Restitution au même endroit",from:"Date et heure de prise en charge",to:"Date et heure de restitution",age:"Âge du conducteur",res:"Pays de résidence (ISO)",search:"Rechercher des voitures",searching:"Recherche…",results:"Voitures disponibles",none:"Aucune voiture disponible pour ces dates / ce lieu.",total:"Total",deposit:"Caution",fuel:"Politique carburant",mileage:"Kilométrage",unlimited:"Km illimités",limited:"km inclus",extraKm:"Km supplémentaires",excess:"Franchise (dommages / vol)",cancel:"Politique d'annulation",included:"Ce qui est inclus",extras:"Options",onreq:"Sur demande — confirmé par le fournisseur",driver:"Coordonnées du conducteur",fn:"Prénom",ln:"Nom",email:"Email",phone:"Téléphone",bdate:"Date de naissance",bcountry:"Pays de naissance (ISO)",rcity:"Ville de résidence",rcountry:"Pays de résidence (ISO)",raddr:"Adresse",cont:"Continuer",back:"Retour",toDriver:"Continuer vers le conducteur",toPay:"Continuer vers le paiement",payTitle:"Paiement",payNote:"💳 Le paiement en ligne par carte est en cours d'activation. Votre voiture et vos données sont enregistrées — une fois activé, vous paierez en toute sécurité ici et la réservation sera confirmée instantanément.",payBtn:"Payer et confirmer la réservation",doneTitle:"Réservation confirmée !",doneMsg:"Vous recevrez les détails de confirmation par email.",ref:"Référence de réservation",voucher:"Voir le bon",close:"Terminé",payErr:"Le paiement n'a pas pu aboutir. Veuillez réessayer.",bookErr:"Paiement effectué mais la réservation est en attente — notre équipe la confirmera sous peu.",driverSel:"Conducteur principal",choose:"— choisir —",yrs:"ans",freeCancel:"Annulation gratuite jusqu'au",cancelFee:"Frais d'annulation à partir de",nonref:"Non remboursable",reqFields:"Sélectionnez le conducteur et saisissez email, téléphone et date de naissance."},
  NL:{open:"Zoek en boek een auto",title:"Autohuur",pickup:"Ophaallocatie",dropoff:"Inleverlocatie",same:"Inleveren op dezelfde locatie",from:"Ophaaldatum en -tijd",to:"Inleverdatum en -tijd",age:"Leeftijd bestuurder",res:"Land van verblijf (ISO)",search:"Zoek auto's",searching:"Zoeken…",results:"Beschikbare auto's",none:"Geen auto's beschikbaar voor deze data / locatie.",total:"Totaal",deposit:"Borg",fuel:"Brandstofbeleid",mileage:"Kilometrage",unlimited:"Onbeperkt km",limited:"km inbegrepen",extraKm:"Extra km",excess:"Eigen risico (schade / diefstal)",cancel:"Annuleringsbeleid",included:"Wat is inbegrepen",extras:"Optionele extra's",onreq:"Op aanvraag — bevestigd door leverancier",driver:"Gegevens bestuurder",fn:"Voornaam",ln:"Achternaam",email:"E-mail",phone:"Telefoon",bdate:"Geboortedatum",bcountry:"Geboorteland (ISO)",rcity:"Woonplaats",rcountry:"Land van verblijf (ISO)",raddr:"Adres",cont:"Doorgaan",back:"Terug",toDriver:"Door naar bestuurder",toPay:"Door naar betaling",payTitle:"Betaling",payNote:"💳 Online betalen met kaart wordt geactiveerd. Je auto en gegevens zijn opgeslagen — zodra actief betaal je hier veilig en wordt de boeking direct bevestigd.",payBtn:"Betalen en boeking bevestigen",doneTitle:"Boeking bevestigd!",doneMsg:"Je ontvangt de bevestigingsgegevens per e-mail.",ref:"Boekingsreferentie",voucher:"Bekijk voucher",close:"Klaar",payErr:"Betaling kon niet worden voltooid. Probeer opnieuw.",bookErr:"Betaling ontvangen maar de boeking is nog in behandeling — ons team bevestigt deze binnenkort.",driverSel:"Hoofdbestuurder",choose:"— kies —",yrs:"jaar",freeCancel:"Gratis annuleren tot",cancelFee:"Annuleringskosten vanaf",nonref:"Niet-restitueerbaar",reqFields:"Selecteer de bestuurder en vul e-mail, telefoon en geboortedatum in."},
  DE:{open:"Auto suchen und buchen",title:"Mietwagen",pickup:"Abholort",dropoff:"Rückgabeort",same:"Rückgabe am selben Ort",from:"Abholdatum und -zeit",to:"Rückgabedatum und -zeit",age:"Alter des Fahrers",res:"Wohnsitzland (ISO)",search:"Autos suchen",searching:"Suche…",results:"Verfügbare Autos",none:"Keine Autos für diese Daten / diesen Ort verfügbar.",total:"Gesamt",deposit:"Kaution",fuel:"Tankregelung",mileage:"Kilometer",unlimited:"Unbegrenzte km",limited:"km inklusive",extraKm:"Zusätzliche km",excess:"Selbstbeteiligung (Schaden / Diebstahl)",cancel:"Stornobedingungen",included:"Was ist inbegriffen",extras:"Optionale Extras",onreq:"Auf Anfrage — vom Anbieter bestätigt",driver:"Fahrerdaten",fn:"Vorname",ln:"Nachname",email:"E-Mail",phone:"Telefon",bdate:"Geburtsdatum",bcountry:"Geburtsland (ISO)",rcity:"Wohnort",rcountry:"Wohnsitzland (ISO)",raddr:"Adresse",cont:"Weiter",back:"Zurück",toDriver:"Weiter zu Fahrerdaten",toPay:"Weiter zur Zahlung",payTitle:"Zahlung",payNote:"💳 Die Online-Kartenzahlung wird aktiviert. Ihr Auto und Ihre Daten sind gespeichert — sobald aktiv, zahlen Sie hier sicher und die Buchung wird sofort bestätigt.",payBtn:"Bezahlen und Buchung bestätigen",doneTitle:"Buchung bestätigt!",doneMsg:"Sie erhalten die Bestätigungsdetails per E-Mail.",ref:"Buchungsreferenz",voucher:"Gutschein ansehen",close:"Fertig",payErr:"Zahlung konnte nicht abgeschlossen werden. Bitte erneut versuchen.",bookErr:"Zahlung erfolgt, aber die Buchung ist noch ausstehend — unser Team bestätigt sie in Kürze.",driverSel:"Hauptfahrer",choose:"— wählen —",yrs:"Jahre",freeCancel:"Kostenlose Stornierung bis",cancelFee:"Stornogebühr ab",nonref:"Nicht erstattbar",reqFields:"Bitte Fahrer auswählen und E-Mail, Telefon und Geburtsdatum eingeben."},
};
const CFX = {
  EN:{dateErr:"Drop-off must be after pick-up, and dates can't be in the past.",all:"All",auto:"Automatic",manual:"Manual",expired:"This quote is no longer available — please search again.",seats:"seats",bags:"bags",backResults:"Back to results",zeroExc:"Zero excess",gearbox:"Gearbox",debitCard:"Debit card",step:{search:"Search",results:"Results",detail:"Details",driver:"Driver",payment:"Payment"}},
  IT:{dateErr:"La riconsegna dev'essere dopo il ritiro e le date non possono essere nel passato.",all:"Tutti",auto:"Automatico",manual:"Manuale",expired:"Questa quotazione non è più disponibile — cerca di nuovo.",seats:"posti",bags:"bagagli",backResults:"Torna ai risultati",zeroExc:"Franchigia azzerata",gearbox:"Cambio",debitCard:"Carta di debito",step:{search:"Ricerca",results:"Risultati",detail:"Dettaglio",driver:"Conducente",payment:"Pagamento"}},
  ES:{dateErr:"La devolución debe ser posterior a la recogida y las fechas no pueden ser pasadas.",all:"Todos",auto:"Automático",manual:"Manual",expired:"Esta cotización ya no está disponible — busca de nuevo.",seats:"plazas",bags:"maletas",backResults:"Volver a resultados",zeroExc:"Franquicia cero",gearbox:"Cambio",debitCard:"Tarjeta de débito",step:{search:"Búsqueda",results:"Resultados",detail:"Detalles",driver:"Conductor",payment:"Pago"}},
  FR:{dateErr:"La restitution doit être après la prise en charge et les dates ne peuvent pas être passées.",all:"Tous",auto:"Automatique",manual:"Manuelle",expired:"Cette offre n'est plus disponible — veuillez rechercher à nouveau.",seats:"places",bags:"bagages",backResults:"Retour aux résultats",zeroExc:"Sans franchise",gearbox:"Boîte",debitCard:"Carte de débit",step:{search:"Recherche",results:"Résultats",detail:"Détails",driver:"Conducteur",payment:"Paiement"}},
  NL:{dateErr:"Inleveren moet na ophalen zijn en data mogen niet in het verleden liggen.",all:"Alle",auto:"Automaat",manual:"Handgeschakeld",expired:"Deze offerte is niet meer beschikbaar — zoek opnieuw.",seats:"stoelen",bags:"koffers",backResults:"Terug naar resultaten",zeroExc:"Geen eigen risico",gearbox:"Transmissie",debitCard:"Debetkaart",step:{search:"Zoeken",results:"Resultaten",detail:"Details",driver:"Bestuurder",payment:"Betaling"}},
  DE:{dateErr:"Rückgabe muss nach Abholung liegen, Daten dürfen nicht in der Vergangenheit sein.",all:"Alle",auto:"Automatik",manual:"Schaltgetriebe",expired:"Dieses Angebot ist nicht mehr verfügbar — bitte erneut suchen.",seats:"Sitze",bags:"Gepäck",backResults:"Zurück zu den Ergebnissen",zeroExc:"Ohne Selbstbeteiligung",gearbox:"Getriebe",debitCard:"Debitkarte",step:{search:"Suche",results:"Ergebnisse",detail:"Details",driver:"Fahrer",payment:"Zahlung"}},
};
...
function CarRentalFlow({b,lang,onClose}){
  ...
  useEffect(()=>{
    ...
    // nascondi il pulsante chat (copre i bottoni del modale a piena pagina su mobile)
  ...
  const chip=(active)=>({border:"1px solid "+(active?"#F15A29":"#d7dce2"),background:active?"#FFF2F0":"#fff",
    color:active?"#F15A29":"#5b6470",borderRadius:20,padding:"7px 13px",fontSize:12,fontWeight:600,cursor:"pointer",
    ...
    <div style={sheet} onClick={e=>e.stopPropagation()}>
      ...
      {step==="search"&&<>
        <div style={body}>
          ...
          <div style={{display:"flex",flexDirection:isMobile?"column":"row",gap:10,marginTop:10}}>
            <div style={{flex:1,minWidth:0}}><label style={cfLbl}>{cf.from}</label><input type="datetime-local" value={pDate} onChange={e=>setPDate(e.target.value)} style={cfInp}/></div>
            <div style={{flex:1,minWidth:0}}><label style={cfLbl}>{cf.to}</label><input type="datetime-local" value={dDate} onChange={e=>setDDate(e.target.value)} style={cfInp}/></div>
          </div>
          ...
          {!busy&&cars.length>0&&(cars.some(c=>c.transmission)||cars.some(c=>c.zeroExcess)||cars.some(c=>c.debitCard))&&
            ...
            {cars.some(c=>c.transmission)&&
              <select value={filterTx} onChange={e=>setFilterTx(e.target.value)} style={chip(!!filterTx)}>
                <option value="">⚙ {cfx.gearbox}</option>
                <option value="automatic">⚙ {cfx.auto}</option>
                <option value="manual">⚙ {cfx.manual}</option>
              </select>}
...
const BF = {
  EN:{open:"Add baggage",title:"Extra baggage",none:"None",total:"Total",toPay:"Continue to payment",pay:"Pay & request baggage",payTitle:"Payment",doneTitle:"Request received!",doneMsg:"We're adding your baggage to your flight. You'll receive a confirmation email shortly.",close:"Done",pick:"Choose baggage per passenger and flight",noflight:"Extra baggage is available only for bookings with a flight.",cutoff:"Extra baggage can no longer be added: less than 24 hours to departure. You can still add it directly on the airline's website.",payErr:"Payment could not be completed. Please try again.",bookErr:"Payment authorized but the request is still pending — our team will confirm shortly.",hold:"You'll be charged only once the baggage is confirmed.",airline:"Airline",outbound:"Outbound",ret:"Return",included:"Already included",cabin:"cabin bag",checked:"checked bag",personal:"personal item",retDiff:"Different baggage for the return",wholeTrip:"Outbound & return",loading:"Loading airline baggage prices…",weightNote:"The weights shown are indicative and may vary by airline. For exact allowances, always check your booking on the airline's website."},
  IT:{open:"Aggiungi bagaglio",title:"Bagaglio extra",none:"Nessuno",total:"Totale",toPay:"Continua al pagamento",pay:"Paga e richiedi il bagaglio",payTitle:"Pagamento",doneTitle:"Richiesta ricevuta!",doneMsg:"Stiamo aggiungendo il bagaglio al tuo volo. Riceverai a breve un'email di conferma.",close:"Fatto",pick:"Scegli il bagaglio per ogni passeggero e volo",noflight:"Il bagaglio extra è disponibile solo per prenotazioni con volo.",cutoff:"Il bagaglio extra non è più aggiungibile: mancano meno di 24 ore alla partenza. Puoi aggiungerlo direttamente sul sito della compagnia aerea.",payErr:"Pagamento non riuscito. Riprova.",bookErr:"Pagamento autorizzato ma la richiesta è in attesa — il team confermerà a breve.",hold:"L'addebito avverrà solo a bagaglio confermato.",airline:"Compagnia",outbound:"Andata",ret:"Ritorno",included:"Già inclusi",cabin:"bagaglio a mano",checked:"bagaglio in stiva",personal:"oggetto personale",retDiff:"Bagagli diversi al ritorno",wholeTrip:"Andata e ritorno",loading:"Carichiamo le tariffe bagagli delle compagnie…",weightNote:"I pesi indicati sono indicativi e possono variare in base alla compagnia. Per le franchigie esatte, verifica sempre la tua prenotazione sul sito della compagnia aerea."},
  ES:{open:"Añadir equipaje",title:"Equipaje extra",none:"Ninguno",total:"Total",toPay:"Continuar al pago",pay:"Pagar y solicitar equipaje",payTitle:"Pago",doneTitle:"¡Solicitud recibida!",doneMsg:"Estamos añadiendo tu equipaje al vuelo. Recibirás un email de confirmación en breve.",close:"Hecho",pick:"Elige el equipaje por pasajero y vuelo",noflight:"El equipaje extra está disponible solo para reservas con vuelo.",cutoff:"El equipaje extra ya no se puede añadir: faltan menos de 24 horas para la salida. Puedes añadirlo directamente en el sitio web de la aerolínea.",payErr:"No se pudo completar el pago. Inténtalo de nuevo.",bookErr:"Pago autorizado pero la solicitud sigue pendiente — nuestro equipo confirmará en breve.",hold:"Solo se te cobrará cuando el equipaje esté confirmado.",airline:"Aerolínea",outbound:"Ida",ret:"Vuelta",included:"Ya incluidos",cabin:"equipaje de mano",checked:"equipaje facturado",personal:"objeto personal",retDiff:"Equipaje diferente a la vuelta",wholeTrip:"Ida y vuelta",loading:"Cargando las tarifas de equipaje de las aerolíneas…",weightNote:"Los pesos indicados son orientativos y pueden variar según la aerolínea. Para las franquicias exactas, consulta siempre tu reserva en el sitio web de la aerolínea."},
  FR:{open:"Ajouter un bagage",title:"Bagage supplémentaire",none:"Aucun",total:"Total",toPay:"Continuer vers le paiement",pay:"Payer et demander le bagage",payTitle:"Paiement",doneTitle:"Demande reçue !",doneMsg:"Nous ajoutons votre bagage à votre vol. Vous recevrez un email de confirmation sous peu.",close:"Terminé",pick:"Choisissez le bagage par passager et par vol",noflight:"Le bagage supplémentaire est disponible uniquement pour les réservations avec vol.",cutoff:"Le bagage supplémentaire ne peut plus être ajouté : moins de 24 heures avant le départ. Vous pouvez l'ajouter directement sur le site de la compagnie aérienne.",payErr:"Le paiement n'a pas pu aboutir. Veuillez réessayer.",bookErr:"Paiement autorisé mais la demande est en attente — notre équipe confirmera sous peu.",hold:"Vous ne serez débité qu'une fois le bagage confirmé.",airline:"Compagnie",outbound:"Aller",ret:"Retour",included:"Déjà inclus",cabin:"bagage cabine",checked:"bagage en soute",personal:"objet personnel",retDiff:"Bagages différents au retour",wholeTrip:"Aller-retour",loading:"Chargement des tarifs bagages des compagnies…",weightNote:"Les poids indiqués sont indicatifs et peuvent varier selon la compagnie. Pour les franchises exactes, vérifiez toujours votre réservation sur le site de la compagnie aérienne."},
  NL:{open:"Bagage toevoegen",title:"Extra bagage",none:"Geen",total:"Totaal",toPay:"Door naar betaling",pay:"Betalen en bagage aanvragen",payTitle:"Betaling",doneTitle:"Aanvraag ontvangen!",doneMsg:"We voegen je bagage toe aan je vlucht. Je ontvangt binnenkort een bevestigingsmail.",close:"Klaar",pick:"Kies bagage per passagier en vlucht",noflight:"Extra bagage is alleen beschikbaar voor boekingen met een vlucht.",cutoff:"Extra bagage kan niet meer worden toegevoegd: minder dan 24 uur tot vertrek. Je kunt het rechtstreeks op de website van de luchtvaartmaatschappij toevoegen.",payErr:"Betaling kon niet worden voltooid. Probeer opnieuw.",bookErr:"Betaling geautoriseerd maar de aanvraag is in behandeling — ons team bevestigt binnenkort.",hold:"Je wordt pas belast zodra de bagage is bevestigd.",airline:"Maatschappij",outbound:"Heen",ret:"Terug",included:"Al inbegrepen",cabin:"handbagage",checked:"ruimbagage",personal:"persoonlijk item",retDiff:"Andere bagage voor terugreis",wholeTrip:"Heen & terug",loading:"Bagagetarieven van de maatschappijen laden…",weightNote:"De vermelde gewichten zijn indicatief en kunnen per maatschappij verschillen. Controleer voor de exacte limieten altijd je boeking op de website van de luchtvaartmaatschappij."},
  DE:{open:"Gepäck hinzufügen",title:"Zusätzliches Gepäck",none:"Keins",total:"Gesamt",toPay:"Weiter zur Zahlung",pay:"Bezahlen & Gepäck anfragen",payTitle:"Zahlung",doneTitle:"Anfrage erhalten!",doneMsg:"Wir fügen Ihr Gepäck zu Ihrem Flug hinzu. Sie erhalten in Kürze eine Bestätigungs-E-Mail.",close:"Fertig",pick:"Wählen Sie das Gepäck pro Passagier und Flug",noflight:"Zusätzliches Gepäck ist nur für Buchungen mit Flug verfügbar.",cutoff:"Zusätzliches Gepäck kann nicht mehr hinzugefügt werden: weniger als 24 Stunden bis zum Abflug. Sie können es direkt auf der Website der Fluggesellschaft hinzufügen.",payErr:"Zahlung konnte nicht abgeschlossen werden. Bitte erneut versuchen.",bookErr:"Zahlung autorisiert, aber die Anfrage ist noch offen — unser Team bestätigt in Kürze.",hold:"Die Belastung erfolgt erst, wenn das Gepäck bestätigt ist.",airline:"Fluggesellschaft",outbound:"Hinflug",ret:"Rückflug",included:"Bereits enthalten",cabin:"Handgepäck",checked:"Aufgabegepäck",personal:"persönlicher Gegenstand",retDiff:"Anderes Gepäck für Rückflug",wholeTrip:"Hin- & Rückflug",loading:"Gepäckpreise der Fluggesellschaften werden geladen…",weightNote:"Die angegebenen Gewichte sind Richtwerte und können je nach Fluggesellschaft variieren. Prüfen Sie die genauen Freigepäckmengen immer in Ihrer Buchung auf der Website der Fluggesellschaft."},
};
...
function BaggageFlow({b,lang,onClose}){
  ...
  return createPortal(<div style={overlay} onClick={onClose}>
    <div style={sheet} onClick={e=>e.stopPropagation()}>
      ...
      {step==="select"&&<>
        <div style={body}>
          {loading&&<div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:10,padding:"34px 10px",color:"#5b6470",fontSize:14,textAlign:"center"}}>
            ...
            <span>🧳 {bf.loading}</span>
          </div>}
          {!loading&&opts&&opts.flight&&opts.available===false&&<div style={{color:"#874d00",fontSize:14,background:"#fff7e6",border:"1px solid #ffe3ad",borderRadius:8,padding:"10px 12px",lineHeight:1.45}}>⏱️ {bf.cutoff}</div>}
          {!loading&&(!opts||!opts.flight||(!legs.length&&opts.available!==false))&&<div style={{color:"#5b6470",fontSize:14}}>{bf.noflight}</div>}
...
const TF = {
  EN:{open:"Book transfer",title:"Airport transfer",loading:"Loading your trip…",
    tripType:"What do you need?",tripRound:"Round trip",tripOut:"One way",tripRet:"One way (return)",
    tripRoundD:"Airport ⇄ stay",tripOutD:"To your stay",tripRetD:"To the airport",
    legOut:"Outbound",legRet:"Return",from:"Pick-up",to:"Drop-off",change:"change",set:"Set",
    searchLoc:"Search airport, hotel or address…",secAirports:"Airports",secPlaces:"Places",
    noFound:"No results — keep typing",bFlight:"from your flight",bBooking:"from your booking",bConfirmed:"confirmed",bEnter:"to set",
    addrReview:"Check this address is correct — search again to change it.",addrConfirm:"I have verified this address is correct",
    ...
    hold:"You'll be charged now; free cancellation applies as shown.",total:"Total",totalRound:"Total round trip",
  ...
  IT:{open:"Prenota transfer",title:"Transfer",loading:"Carico il tuo viaggio…",
    tripType:"Cosa ti serve?",tripRound:"Andata e ritorno",tripOut:"Solo andata",tripRet:"Solo ritorno",
    tripRoundD:"Aeroporto ⇄ struttura",tripOutD:"Verso la struttura",tripRetD:"Verso l'aeroporto",
    legOut:"Andata",legRet:"Ritorno",from:"Ritiro",to:"Destinazione",change:"modifica",set:"Imposta",
    searchLoc:"Cerca aeroporto, hotel o indirizzo…",secAirports:"Aeroporti",secPlaces:"Luoghi",
    noFound:"Nessun risultato — continua a scrivere",bFlight:"dal tuo volo",bBooking:"dalla prenotazione",bConfirmed:"confermato",bEnter:"da impostare",
    addrReview:"Controlla che l'indirizzo sia corretto — cerca di nuovo per cambiarlo.",addrConfirm:"Ho verificato che questo indirizzo è corretto",
    ...
    hold:"L'addebito avviene ora; vale la cancellazione gratuita indicata.",total:"Totale",totalRound:"Totale andata e ritorno",
...
function TransferFlow({b,lang,onClose}){
  ...
  const [tripType,setTripType]=useState("roundtrip");   // roundtrip | outbound | return
  const [bookingType,setBookingType]=useState("standard");
  const [accs,setAccs]=useState([]);                    // accommodations (0/1 standard, N tour)
  // punti generici per tratta: {kind:"airport"|"place", iata,label,address,lat,lon,fromNinox,verified,acc}
  const [outP,setOutP]=useState(null); const [outD,setOutD]=useState(null);   // andata: ritiro/destinazione
  const [retP,setRetP]=useState(null); const [retD,setRetD]=useState(null);   // ritorno: ritiro/destinazione
  const [whenOut,setWhenOut]=useState(""); const [whenRet,setWhenRet]=useState("");
  ...
  const fmtHM=(s)=> String(s||"").slice(11,16);
  ...
  const minusHours=(s,h)=>{ if(!s) return ""; const d=new Date(s); if(isNaN(d.getTime())) return s; d.setHours(d.getHours()-h); const z=n=>String(n).padStart(2,"0"); return `${d.getFullYear()}-${z(d.getMonth()+1)}-${z(d.getDate())}T${z(d.getHours())}:${z(d.getMinutes())}`; };

  const legList = tripType==="roundtrip"?["outbound","return"]:tripType==="return"?["return"]:["outbound"];
  ...
  const matchAcc=(list,ms,mode)=>{
    ...
    const t=ms?new Date(ms):null; const key=mode==="out"?"checkOut":"checkIn";
    if(!t||isNaN(t.getTime())) return mode==="out"?list[list.length-1]:list[0];
    let best=null,bd=Infinity;
    for(const a of list){ if(!a[key])continue; const d=new Date(a[key]); if(isNaN(d.getTime()))continue; const diff=Math.abs(d.getTime()-t.getTime()); if(diff<bd){bd=diff;best=a;} }
    return best||(mode==="out"?list[list.length-1]:list[0]);
  };
  const accSuggest=(dir)=> matchAcc(accs, ctx&&(dir==="outbound"?ctx.arrivalTime:ctx.departureTime), dir==="outbound"?"in":"out");

  useEffect(()=>{
    let dead=false;
    fetch(`${API_TRANSFER}/${slugRef.current}?lang=${lang}`).then(r=>r.json()).then(d=>{
      if(dead) return; const c=d.context||{}; setCtx(c);
      const arr=c.arrivalAirport||{}, dep=c.departureAirport||{};
  ...
  // ricerca unificata: aeroporti + luoghi in un solo box
  useEffect(()=>{
    const q=locQ.trim();
    if(!locOpen||q.length<2){ setLocAir([]); setLocPlc([]); return; }
    const t=setTimeout(()=>{
      fetch(`${API_TRANSFER}/locations?q=${encodeURIComponent(q)}&lang=${String(lang).toLowerCase()}`).then(r=>r.json()).then(d=>{
        setLocAir(Array.isArray(d.airports)?d.airports:[]); setLocPlc(Array.isArray(d.places)?d.places:[]);
      }).catch(()=>{setLocAir([]);setLocPlc([]);});
    },300);
  ...
  const openSearch=(fid)=>{ setLocOpen(fid); setLocQ(""); setLocAir([]); setLocPlc([]); };
  const chooseLoc=(setter,r,kind)=>{ setter(resToPoint(r,kind)); setLocOpen(null); setLocQ(""); setLocAir([]); setLocPlc([]); };

  const legPick=(dir)=> dir==="outbound"?outP:retP;
  const legDrop=(dir)=> dir==="outbound"?outD:retD;
  ...
  const buildLegs=(withFlight)=> legList.map(dir=>{
    const p=legPick(dir), d=legDrop(dir);
    const o={pickup:pointLoc(p),dropoff:pointLoc(d),pickupDateTime:legWhen(dir)+":00",direction:dir,
      pickupLabel:(p&&p.label)||"",dropoffLabel:(d&&d.label)||""};
    if(withFlight){ o.flightNumber=(dir==="outbound"?flightOut:flightRet)||""; const ft=legFlightTime(dir); if(ft) o.flightTimeOfArrival=ft; }
    return o;
  });

  async function runSearch(){
    setSearchErr(""); setSearching(true); setOptions([]);
    try{
      const r=await fetch(`${API_TRANSFER}/search`,{method:"POST",headers:{"Content-Type":"application/json"},
        body:JSON.stringify({legs:buildLegs(false),pax,lang})});
      const d=await r.json(); const list=Array.isArray(d.options)?d.options:[];
      setOptions(list);
  ...
  useEffect(()=>{
    ...
    (async()=>{
      setPayErr("");
      try{
        const r=await fetch(`${API_TRANSFER}/payment-intent`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(piBody())});
        ...
        const elements=stripe.elements({clientSecret:d.client_secret}); elementsRef.current=elements;
        const el=elements.create("payment");
        setTimeout(()=>{ if(!dead&&document.getElementById("bb-tr-pay-el")) el.mount("#bb-tr-pay-el"); },30);
      }catch(e){ if(!dead) setPayErr(tf.payErr); }
    })();
    return ()=>{dead=true;};
  },[step]);
  async function payAndBook(){
  ...
  const goNext=()=>{ if(stepIdx>=0&&stepIdx<flow.length-1) setStep(flow[stepIdx+1]); };
  ...
  const Badge=({kind})=>{ const green=kind!=="enter";
    ...
    return <span style={{fontSize:10,fontWeight:700,color:green?"#1e874b":"#8a5a00",background:green?"#e8f6ef":"#fff5e0",borderRadius:6,padding:"2px 7px",whiteSpace:"nowrap"}}>{green?"✓ ":"⚠ "}{txt}</span>; };

  // box di ricerca unificato (aeroporti + luoghi)
  const searchBox=(setter)=>(
    <div style={{position:"relative"}}>
      <input autoFocus value={locQ} placeholder={tf.searchLoc} onChange={e=>setLocQ(e.target.value)} style={inp}/>
  ...
  // campo accommodation: selettore per tour multi-hotel, altrimenti pointField
  const accField=(dir)=>{
    const isOut=dir==="outbound";
    const point=isOut?outD:retP; const setter=isOut?setOutD:setRetP;
    const fid=isOut?"out-acc":"ret-acc"; const role=isOut?tf.to:tf.from;
    if(bookingType==="tour"&&accs.length>1){
      const sug=accSuggest(dir);
  ...
  const legStep=(dir)=>{
    ...
    return <>
      ...
      <div style={foot}>
        ...
        <button onClick={goNext} disabled={!ready} style={{...primary,opacity:ready?1:.5}}>{tf.next}</button>
      </div>
    </>;
  };

  const showProg = !loading && step!=="done" && stepIdx>=0;
  ...
  return createPortal(<div style={overlay} onClick={onClose}>
    <div style={sheet} onClick={e=>e.stopPropagation()}>
      ...
      {!loading&&step==="trip"&&<>
        <div style={body}>
          <p style={{...lbl,marginBottom:8}}>{tf.tripType}</p>
          <div style={{display:"flex",gap:8,marginBottom:16}}>
            {tripChip("roundtrip",tf.tripRound,tf.tripRoundD)}
            {tripChip("outbound",tf.tripOut,tf.tripOutD)}
            {tripChip("return",tf.tripRet,tf.tripRetD)}
          </div>
          <div style={{width:130}}><p style={lbl}>{tf.pax}</p><input type="number" min={1} max={16} value={pax} onChange={e=>setPax(Math.max(1,parseInt(e.target.value||"1",10)))} style={inp}/></div>
        </div>
        <div style={foot}><button onClick={goNext} style={primary}>{tf.next}</button></div>
      </>}

      {!loading&&step==="leg-outbound"&&legStep("outbound")}
      {!loading&&step==="leg-return"&&legStep("return")}

      {!loading&&step==="vehicle"&&<>
        <div style={body}>
          <p style={{fontSize:14,fontWeight:700,margin:"0 0 8px"}}>{tf.vehTitle}</p>
          <div style={{fontSize:12,color:"#5b6470",marginBottom:12}}>
            {legList.map((d,i)=><div key={i}>{legList.length>1?`${d==="outbound"?tf.perLegOut:tf.perLegRet}: `:""}{legRouteLbl(d)} · {fmtDT(legWhen(d)+":00")}</div>)}
          </div>
          {searching&&<div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:10,padding:"24px 10px",color:"#5b6470",fontSize:13}}>
            <div style={{width:24,height:24,border:"3px solid #eef0f3",borderTopColor:"#F15A29",borderRadius:"50%",animation:"spin .8s linear infinite"}}/><span>{tf.searching}</span></div>}
          ...
          {!searching&&searchErr&&<p style={{color:"#c0392b",fontSize:12,margin:"6px 0 0"}}>{searchErr}</p>}
        </div>
        <div style={foot}><button onClick={goBack} style={ghost}>‹ {tf.back}</button></div>
      </>}
      ...
      {!loading&&step==="passenger"&&sel&&<>
        ...
        <div style={foot}>
          <button onClick={goBack} style={ghost}>‹ {tf.back}</button>
          <button onClick={()=>{ if(paxValid) setStep("payment"); }} disabled={!paxValid} style={{...primary,opacity:paxValid?1:.5}}>{tf.toPay}</button>
        </div>
      </>}
      ...
      {!loading&&step==="done"&&<>
        <div style={body}><div style={{textAlign:"center",padding:"24px 10px"}}>
          ...
          <p style={{fontSize:13,color:"#5b6470"}}>{tf.doneMsg}</p>
        </div></div>
        <div style={foot}><button onClick={onClose} style={primary}>{tf.close}</button></div>
      </>}
    </div>
  </div>, document.body);
}
...
function Shop({b,lang,services}){
  ...
  useEffect(()=>{
    ...
    if(s==="baggage"||s==="carrental"||s==="transfer") setFlow(s);
  },[]);
  ...
  return <div style={{maxWidth:1100,margin:"0 auto",padding:"1.5rem 1.25rem"}}>
          ...
          {(()=>{
            ...
            if(card.live)
              return <button onClick={()=>setFlow(card.live)} style={{background:"#F15A29",color:"#fff",border:"none",
                  ...
                  display:"inline-flex",alignItems:"center",justifyContent:"center",gap:6}}>
                  <Ico name="bb-search" size={14} light/> {card.live==="baggage"?(BF[lang]||BF.EN).open:card.live==="transfer"?(TF[lang]||TF.EN).open:(CF[lang]||CF.EN).open}
                </button>;
    ...
    {flow==="transfer"&&<TransferFlow b={b} lang={lang} onClose={()=>setFlow(null)}/>}
  </div>;
}
...
export default function App(){
  ...
  useEffect(()=>{
    const s=getQ("service");
    if(s!=="baggage"&&s!=="carrental") return;
    const hasCard = services.some(c=>c.id===s||c.live===s);
    // Se la card bagaglio è nascosta dal cutoff 24h ma il deep-link (welcome letter)
    // la richiede su una prenotazione con volo, apriamo comunque il funnel: mostrerà
    // il messaggio "non più aggiungibile" invece di lasciare la pagina muta.
    const baggageLate = s==="baggage" && !!(booking&&booking.flight);
    if(hasCard||baggageLate) setTab("shop");
  },[services,booking]);
